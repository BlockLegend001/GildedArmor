...
public class ModConfig {
    ...
    public static int protectionValueGildedBody = 27;
    ...
    public static void loadConfig() {
        ...
        if (!CONFIG_FILE.exists()) {
            ...
            try (FileReader reader = new FileReader(CONFIG_FILE)) {
                ...
                protectionValueGildedBody  = config.get("protectionValueGildedBody").getAsInt();
    ...
    public static void saveConfig() {
        ...
        config.addProperty("protectionValueGildedBody", protectionValueGildedBody);
        config.addProperty("durabilityValueGildedArmor", durabilityValueGildedArmor);
