...
public class ModItems {
    ...
    public static final Item GILDED_NETHERITE_HELMET = registerItem("gilded_netherite_helmet",
            new GildedArmorItem(ModArmorMaterial.GILDED_NETHERITE, ArmorItem.ArmorSlot.HELMET,
    ...
    public static final Item GILDED_NETHERITE_CHESTPLATE = registerItem("gilded_netherite_chestplate",
            new GildedArmorItem(ModArmorMaterial.GILDED_NETHERITE, ArmorItem.ArmorSlot.CHESTPLATE,
                    new QuiltItemSettings().maxCount(1).fireproof()));

    public static final Item GILDED_NETHERITE_LEGGINGS = registerItem("gilded_netherite_leggings",
            new GildedArmorItem(ModArmorMaterial.GILDED_NETHERITE, ArmorItem.ArmorSlot.LEGGINGS,
                    new QuiltItemSettings().maxCount(1).fireproof()));

    public static final Item GILDED_NETHERITE_BOOTS = registerItem("gilded_netherite_boots",
            new GildedArmorItem(ModArmorMaterial.GILDED_NETHERITE, ArmorItem.ArmorSlot.BOOTS,
                    new QuiltItemSettings().maxCount(1).fireproof()));
