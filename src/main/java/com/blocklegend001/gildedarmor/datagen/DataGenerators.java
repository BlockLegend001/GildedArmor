...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent.Client event) {
        ...
        ModBlockTagGenerator blockTagsProvider = new ModBlockTagGenerator(packOutput, lookupProvider, GildedArmor.MODID);
        ModItemTagGenerator itemTagsProvider = new ModItemTagGenerator(packOutput, lookupProvider, blockTagsProvider.contentsGetter());
        ModItemModelProvider itemModelProvider = new ModItemModelProvider(packOutput, GildedArmor.MODID);
